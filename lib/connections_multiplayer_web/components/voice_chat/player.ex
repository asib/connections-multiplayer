defmodule ConnectionsMultiplayerWeb.VoiceChat.Player do
  ...
  # attr(:class, :string, default: nil, doc: "CSS/Tailwind classes for styling HTMLAudioElement")
  ...
  * `class` - a list of CSS/Tailwind classes that will be applied to the HTMLVideoPlayer. Defaults to "".
  ...
  def render(assigns) do
    ~H"""
    <div id={@player.id} phx-hook="Player">
  ...
  def mount(_params, %{"publisher_id" => pub_id, "room_id" => room_id}, socket) do
    socket =
      assign(socket, player: nil, room_id: room_id, last_sequence_number: nil)
